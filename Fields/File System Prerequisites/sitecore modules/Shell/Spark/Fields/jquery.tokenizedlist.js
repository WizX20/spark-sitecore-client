...
$.TokenList = function (input, url_or_data_or_function, settings) {
    ...
    function insert_token(object) {
        ...
        if (typeof object.site !== "undefined") {

	        if (object.site == null) {
		        token_name = "<p><span class=\"token-input-token-site-facebook\">Unmatched People</span>" + escapeHTML(object.name) + "</p>";
	        } else {
		        token_name = "<p><span class=\"token-input-token-site-facebook\">" + escapeHTML(object.site) + "</span>" + escapeHTML(object.name) + "</p>";
	        }
        } else {
    ...
    function run_search(query) {
        ...
        if(cached_results) {
            ...
            if(settings.url) {
                ...
                // Prepare the request
				ajax_params.data["sitename"] = settings.luceneSiteName;
                ajax_params.data["templateid"] = settings.luceneTemplateId;
                ajax_params.data["language"] = settings.luceneLanguage;
                ajax_params.data["fullsite"] = settings.luceneFullSite;
